                ...
                >
                    ...
                    <section id="about" className="flex flex-col">
                        <p className="text-justify ">
                            I{"'"}m a frontend web developer with strong knowledge of backend. I
                            have expertise in building web sites and web applications, currently
                            working with React. Focusing on UI dev, web perf and accessibility.
                        </p>
                    </section>
                        ...
                        <div className="basis-2/3">
                            <section id="experience" className="mb-4 flex flex-col gap-2 ">
                                ...
                                <span className="text-gray-400">
                                    Aug 2023 - Present | London - UK | Remote
                                </span>
                                <p className="">
                                ...
                                <p>
                                    I have been developing and mantaining several products, ranging
                                    from complete website redesigns, full-stack products, new
                                    features and bug fixes, with strong focus on UI/UX, web perf and
                                    accessibility, using Next.js (React), Radix UI components,
                                    Storybook.
                                </p>
                            </section>
                            <section id="courses" className="mb-4 flex flex-col gap-2 ">
                                ...
                                <span className="text-gray-400">
                                    2023 | Cordoba - Argentina | Remote
                                </span>
                                <p className="">
                                    <span className="font-semibold">Software development</span> at
                            ...
                            <section id="education" className="mb-4 flex flex-col gap-2 ">
                                ...
                                <span className="text-gray-400">
                                    2014 - 2019 | Neuquen - Argentina
                                </span>
                                <p className="">
                                    <span className="font-semibold">Engineering</span> at National
                                    University of Comahue.
                                </p>
                                <span className="text-gray-400">
                                    2009 - 2013 | Neuquen - Argentina
                                </span>
                                <p className="">
                                    Biology{' '}
