        ...
        <div className="flex flex-col items-center justify-center gap-20 lg:gap-28">
          <div id="project-1" className="grid grid-cols-1 gap-10 md:grid-cols-6">
            <div className="flex flex-col gap-4 md:col-span-4">
              <h3 className="text-xl font-medium lg:text-2xl">E-commerce Web Application</h3>
              <p className=" text-gray-600 dark:text-gray-400 lg:text-lg">
                Developing a E-commerce Application. The application will feature an easy-to-use
                interface where customers can browse products, add items to their shopping cart, and
              ...
              <div className="flex flex-col gap-4 md:flex-row">
                <Button
                  href={'https://guidogennari-shop.vercel.app/products/all-products/newest'}
                  target="_blank"
                  colorScheme="gray"
                  styleScheme="outline"
                >
          ...
          <div id="project-2" className="grid grid-cols-1 gap-10 md:grid-cols-6">
            <div className="flex flex-col gap-4 md:col-span-4">
              ...
              <p className=" text-gray-600 dark:text-gray-400 lg:text-lg">
                Developing websites that are specifically tailored for a marketing campaign or a
